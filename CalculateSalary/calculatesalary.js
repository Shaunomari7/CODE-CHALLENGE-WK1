//   Kenyan Employees Net Salary Calculator
...
function calcTaxOnTaxableIncome() { 
    // This function uses the kra tax system to calculate the percentage tax on income :
    let amount = 0;
...
function calcRelief() {
    //relief on monthly is 24400 but on yearly is 28800 
    let releif = 2400;
...
function calcTotalIncome(){
    // returns total taxable income for employee
...
function calcNhifDeductions(){
    // based on kra tax system compares different levels of nhif system 
...
function calcNssfDeduction() {
    // Based on new kra nssf deduction guidelines
